...
<body>
            ...
            <div class="dashboard-analytics">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Analytics</h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <h3>Analytics by Month</h3>
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Calls</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">347</h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Running Costs</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">$35.23</h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span><i class="fa fa-fw fa-arrow-down"></i></span><span>87.3%</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Avg. Call Length</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">2m31s</h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Avg. Star Rating</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">4.6/5</h1>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Recent Calls</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Anticipated Major</th>
                                                        <th class="border-0">Type</th>
                                                        <th class="border-0">Call Length</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="9"><a href="history.php" class="btn btn-outline-light float-right">View More</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
    ...
    <!-- chart chartist js -->
    <script src="../_assets/vendor/charts/chartist-bundle/chartist.min.js"></script>
    <!-- sparkline js -->
    <script src="../_assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <!-- morris js -->
    <script src="../_assets/vendor/charts/morris-bundle/raphael.min.js"></script>
    <script src="../_assets/vendor/charts/morris-bundle/morris.js"></script>
    <!-- chart c3 js -->
    <script src="../_assets/vendor/charts/c3charts/c3.min.js"></script>
    <script src="../_assets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
    <script src="../_assets/vendor/charts/c3charts/C3chartjs.js"></script>
    <script src="../_assets/libs/js/dashboard-ecommerce.js"></script>
</body>
